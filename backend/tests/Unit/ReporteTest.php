...
class ReporteTest extends TestCase {
    ...
    private function crearDatosPrueba() {
        ...
        $conn->query("INSERT INTO usuario (ID_Usuario, nombre, apellido, ci, email, usuario_asignado, contrasena, tipo, estado)
                     VALUES ('$emisorId', 'Emisor', 'Prueba', '0900000001', 'emisor@test.com', 'emisor', '123456789', 'Administrador', 'Activo')");

        $conn->query("INSERT INTO usuario (ID_Usuario, nombre, apellido, ci, email, usuario_asignado, contrasena, tipo, estado)
                     VALUES ('$destinatarioId', 'Carlos', 'Tecnico', '0900000002', 'carlos@tecnico.com', 'carlostec', '12345678', 'Tecnico', 'Activo')");
        ...
        $conn->query("INSERT INTO reporte (ID_Reporte, ID_Usuario_Emisor, ID_Usuario_Destinatario, descripcion, estado, fecha_hora)
                      VALUES ('$reporteId', '$emisorId', '$destinatarioId', 'Pantalla no enciende', 'Pendiente', NOW())");
    }
