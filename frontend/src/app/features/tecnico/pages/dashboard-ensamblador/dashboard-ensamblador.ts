      ...
      <div class="dashboard-sections">
          ...
          <div class="machine-list">
            ...
            <div *ngIf="mostrarReensamblando">
              ...
              <div class="action-buttons" *ngIf="maquinasReensamblando.length > 0">
                <button mat-raised-button color="primary" 
                        (click)="abrirModalMensajeReensamblar()"
        ...
        <section class="actions-section">
          ...
          <div class="action-buttons">
            <button mat-raised-button (click)="irAGestionComponentes()">
...
export class DashboardEnsambladorComponent implements OnInit {
  ...
  abrirModalMensajeReensamblar(): void {
    this.abrirModalMensaje('reensamblar');
  }
