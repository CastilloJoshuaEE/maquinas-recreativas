          ...
          <form [formGroup]="filtrosForm" class="filtros-form">
            ...
            <mat-form-field appearance="outline">
              ...
              <mat-select formControlName="estado">
                ...
                <mat-option value="Distribuyendose">Distribuyéndose</mat-option>
              </mat-select>
        ...
        <div class="tabla-container">
          ...
          <div *ngIf="!loading && !error">
            <div class="table-header">
              ...
              <button mat-raised-button (click)="exportarExcel()" class="export-btn" *ngIf="dataSource.data.length > 0">
                ...
                <ng-container matColumnDef="estado">
                  ...
                  <td mat-cell *matCellDef="let row">
                    <span class="estado-badge" [ngClass]="{
                      ...
                      'estado-distribucion': row.estado === 'Distribuyendose'
                    }">
...
export class ConsultarInformeDistribucionLogisticaComponent implements OnInit, AfterViewInit {
  ...
  exportarExcel(): void {
    ...
    const csvData = data.map(row => [
      row.ID_Distribucion,
      row.Nombre_Maquina,
      row.Nombre_Tecnico || 'No asignado',
      row.Nombre_Comercio || 'Desconocido',
      new Date(row.fecha_alta).toLocaleString(),
